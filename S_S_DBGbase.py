...
while True:
    ...
    for enemy in enemies:
        ...
        if castle_health <= 0:
            # Handle game over logic here, such as displaying a message or resetting the game
            pass
    ...
    # Display important information (e.g., player's score, level, etc.) on the bottom box
    ...
    # Display the gold amount in the bottom box
    text = font.render("Gold: " + str(int(gold)), True, (255, 255, 255))
    screen.blit(text, (20, HEIGHT - HEIGHT // 6 + 40))

    # Draw a button to recruit guards
    pygame.draw.rect(screen, (0, 0, 255), (350, HEIGHT - HEIGHT // 6 + 20, 100, 40))
    text = font.render("Recruit Guard", True, (255, 255, 255))
    screen.blit(text, (355, HEIGHT - HEIGHT // 6 + 30))
